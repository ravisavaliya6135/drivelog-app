            ...
            <div className="space-y-2.5 pt-1">
              <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/60 dark:border-slate-700/60 flex items-start gap-3">
                ...
                <div className="text-xs text-slate-700 dark:text-slate-300">
                  Tap the <strong className="text-slate-900 dark:text-white inline-flex items-center gap-1"><Share className="w-3 h-3 text-teal-700 inline" /> Share</strong> button at the bottom of Safari.
                </div>
              </div>
              ...
              <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/60 dark:border-slate-700/60 flex items-start gap-3">
                ...
                <div className="text-xs text-slate-700 dark:text-slate-300">
                  Scroll down and tap <strong className="text-slate-900 dark:text-white inline-flex items-center gap-1"><PlusSquare className="w-3 h-3 text-teal-700 inline" /> Add to Home Screen</strong>.
                </div>
              </div>
